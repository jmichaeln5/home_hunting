...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { address: @apartment.address, angel_rating: @apartment.angel_rating, jon_rating: @apartment.jon_rating, link: @apartment.link } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { address: @apartment.address, angel_rating: @apartment.angel_rating, jon_rating: @apartment.jon_rating, link: @apartment.link } }
